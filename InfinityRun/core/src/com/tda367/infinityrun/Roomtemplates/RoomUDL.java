    ...
    public void addRoomObjects(int offsetX, int offsetY) {
...

        {
            for (int j = 0; j < 5; j++) {
                ...
                roomObjects.add(new BrickObject(new Vec2(offsetX * 25 * block + 15 * block + i * 64, offsetY * 14 * block + 0 + j * 64)));
                ...
                //central platforms
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 13 * block, offsetY * 14 * block + 7 * block + 16)));
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 10 * block, offsetY * 14 * block + 10 * block)));
                //todo fall through platforms
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 10 * block, offsetY * 14 * block + 13 * block + 16)));
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 12 * block, offsetY * 14 * block + 13 * block + 16)));
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 12 * block, offsetY * 14 * block + 13 * block + 16)));

                //fall tghough again
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 13 * block, offsetY * 14 * block + 3 * block + 16)));
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 10 * block, offsetY * 14 * block + 1 * block + 16)));
                roomObjects.add(new Platform(new Vec2(offsetX * 25 * block + 12 * block, offsetY * 14 * block + 1 * block + 16)));
